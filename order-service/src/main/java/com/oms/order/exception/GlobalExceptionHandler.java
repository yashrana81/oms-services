...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleCannotAcquireLockException(
        ...
        return buildErrorResponse(HttpStatus.CONFLICT, 
            "Order is being processed by another request. Please try again", request);
    }
    ...
    public ResponseEntity<ErrorResponse> handleDataIntegrityViolation(
        ...
        return buildErrorResponse(HttpStatus.BAD_REQUEST, 
            "Invalid data provided. Please check your input", request);
    }
    ...
    public ResponseEntity<ErrorResponse> handleQueryTimeout(
        ...
        return buildErrorResponse(HttpStatus.REQUEST_TIMEOUT, 
            "Request took too long. Please try again", request);
    }
    ...
    public ResponseEntity<ErrorResponse> handleDataAccessException(
        ...
        return buildErrorResponse(HttpStatus.INTERNAL_SERVER_ERROR, 
            "An error occurred while accessing the database", request);
    }
